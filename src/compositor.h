...
void
notify_tablet_focus_in(struct weston_seat *seat, struct weston_tablet *tablet,
		       uint32_t time, struct weston_view *view, wl_fixed_t sx,
		       wl_fixed_t sy);
void
notify_tablet_focus_out(struct weston_seat *seat, struct weston_tablet *tablet,
